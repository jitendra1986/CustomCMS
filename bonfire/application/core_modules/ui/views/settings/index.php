        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped table-condensed">
                ...
                <tbody>
                    <tr>
                        <td>
                            <select id="action<?php echo $count; ?>" name="action<?php echo $count; ?>" class="form-control m-b">
                        ...
                        <td>
                            <input type="text" id="shortcut<?php echo $count; ?>" name="shortcut<?php echo $count; ?>" class="form-control" value="<?php echo set_value('shortcuts[' . $count . ']', isset($shortcut) ? $shortcut : '') ?>" />
                        </td>
                        <td>
                            <input type="submit" name="add_shortcut" class="btn btn-primary" id="add_shortcut<?php echo $count; ?>" value="<?php echo lang('ui_add_shortcut') ?>"/>
                        </td>
                    </tr>
                    <?php foreach ($settings as $action => $shortcut): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="shortcut<?php echo $count; ?>" name="shortcut[<?php echo $count; ?>]"  value="<?php echo set_value('shortcuts[' . $count . ']', isset($shortcut) ? $shortcut : '') ?>" class="form-control"/>
                            </td>
                            <td>
