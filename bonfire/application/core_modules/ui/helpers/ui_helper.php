...
if (!function_exists('render_filter_first_letter')) {
    ...
    function render_filter_first_letter($caption = null) {
        ...
        if (!empty($current)) {
            ...
            $out .= '<div class="form-group"><label class="col-sm-2 control-label"><a href="' . $href . '" class="btn btn-small btn-primary">' . lang('bf_clear') . '</a></label>';
        } else {
            $out .= '<div class="form-group"><label class="col-sm-2 control-label">' . $caption . '</label>';
        }
